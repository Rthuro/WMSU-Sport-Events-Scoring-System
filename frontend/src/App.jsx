  ...
  return (
    <div className="pb-16">
        ...
        <div id="hero" className="bg-fill h-lvh w-full relative bg-center"
          ...
          <div className="flex flex-col items-center justify-center h-full gap-16 z-20">
            <div className="flex flex-col gap-3 items-center">
              <p className="font-bold text-9xl drop-shadow-md text-primary">WMSU SPORTS</p>
              <p className=" text-3xl drop-shadow-md text-white">The Official WMSU Sports Event Website</p>
            </div>
        ...
        <div className="overflow-hidden mx-16 my-24">
            <div className="flex gap-5 animate-loopScroll w-fit pr-24">
                {[...departments, ...departments].map( (department, idx) => (
                  <div key={idx} className="flex items-center min-w-fit gap-1">
                      <img src={department.logo} alt="" className="size-12" />
                      <p className="text-xs w-fit max-w-[235px] break-normal">

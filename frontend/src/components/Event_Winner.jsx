...
const Event_Winner = ({event_name, event_date, match_start_time,match_end_time,sports_category, team_a, team_b, team_a_logo, team_b_logo, winner}) =>{
    ...
    const winner_team_display_style = 'flex items-center justify-between flex-1 bg-secondary text-primary border-l-4 border-primary p-2 font-medium';
        ...
        <div className="flex flex-col items-center p-3">
            <div className="border-b border-zinc-200 w-full p-2">
                <div className='flex items-center justify-between'>
                                <p id="event_name" className="font-semibold text-secondary text-lg">{event_name}</p>
                                <Ellipsis />
                </div>
            ...
            <p className="text-lg font-medium text-secondary">{sports_category}</p>
            </div>
